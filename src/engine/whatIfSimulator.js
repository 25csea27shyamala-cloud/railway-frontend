 ...
 */
export function generateWhatIfPlans(trains, _tracks, conflicts, activeScenarioId) {
...
export function simulateCustomPerturbation(trains, modifiedTrainId, delayAddedMin, speedCapKmh, closedTrackId) {
